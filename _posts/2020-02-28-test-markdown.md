...
subtitle: from open redirect to a complete account takeover
...
![open redirect-1](/assets/img/open-redir-to-ato/open%20redirect-2.png){: .mx-auto.d-block :}
...
![ato-exp-1](/assets/img/open-redir-to-ato/ato.png)

These issues were responsibly reported to the affected company and are now fixed.

# Timeline

Aug 29, 2020 - the initial discovery of open redirect and path traversal
